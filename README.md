...
├── README.md
└── GNN_for_FEM_stress_prediction.pdf
```
...
If you want to know more about the project, the mathematical details of the architectures, or the extended analysis of the results, please check the **[Full Project Report]** available in this repository.
